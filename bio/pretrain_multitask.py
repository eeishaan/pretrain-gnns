...
def main():
    ...
    parser.add_argument('--mode', type=str, default="cbow",
    ...
    mask_dataset = BioDataset(root_unsupervised, data_type='unsupervised',
                              transform=MaskEdge(mask_rate=args.mask_rate))
    context_dataset = BioDataset(root_unsupervised, data_type='unsupervised',
