...
class GNN_graphpred(torch.nn.Module):
    ...
    def __init__(self, num_layer, emb_dim, num_tasks, JK="last", drop_ratio=0, graph_pooling="mean", gnn_type="gin",
        ...
        self.info_graph_mode = info_graph_mode
        ...
        if self.info_graph_mode:
            self.info_graph_linear = Linear(emb_dim * 5, 2 * emb_dim)
    ...
    def forward(self, data):
        ...
        if self.info_graph_mode is False:
            ...
            x, _ = node_representation
            graph_rep = self.info_graph_linear(x)
